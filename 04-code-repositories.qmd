...
UCD-SeRG projects use R package structure for all R-based work. This chapter outlines the standard organization for R packages in our lab, which provides benefits for reproducibility, collaboration, and code quality even for analysis-only projects.
...
│   ├── intro.Rmd       # Main vignettes (shipped with package)
│   ├── tutorial.Rmd
...
**Articles** (`vignettes/articles/*.Rmd`):
