...
{{< include 04-code-repositories/configuration-config-file.qmd >}}

## Order Files and Directories

{{< include 04-code-repositories/order-files-and-directories.qmd >}}

## Using Bash scripts to ensure reproducibility

{{< include 04-code-repositories/using-bash-scripts-to-ensure-reproducibility.qmd >}}
