...
- One team member (the "PR manager") wrote the original prompt or issue that Copilot is addressing
- Copilot created the PR with the PR manager as co-author
- The PR manager requested your review
- Copilot may have also automatically reviewed the PR

**As a non-managing reviewer, your role is to provide feedback,
...
**For PR managers (the person who prompted Copilot):**
