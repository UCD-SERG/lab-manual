...
- One team member (the "prompter") wrote the original prompt or issue that Copilot is addressing
...
3. The new prompter takes over responding to Copilot and managing future iterations
4. Update PR comments or description to reflect the current prompter if helpful
