...
use GitHub's suggestion feature to allow authors to quickly accept changes directly in the UI.
...
![Example of an automated PR preview comment posted by GitHub Actions](assets/images/quarto-preview-comment.svg){#fig-preview-comment}
