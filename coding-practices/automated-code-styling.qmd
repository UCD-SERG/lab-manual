...
### jarl (Fast Rust-Powered Linter)

[`{jarl}`](https://jarl.etiennebacher.com/) is a high-performance R linter written in Rust by Etienne Bacher.
It checks many common style and syntax rules significantly faster than `{lintr}`, making it well-suited for fast pre-commit hooks and large codebases.

See also [Automated Tools](@sec-style-auto-style).
