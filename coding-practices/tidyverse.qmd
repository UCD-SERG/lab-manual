...
[`{purrr}`](https://purrr.tidyverse.org/) enhances R's functional programming (FP) toolkit
...
you can check out [this document](https://tavareshugo.github.io/data_carpentry_extras/base-r_tidyverse_equivalents/base-r_tidyverse_equivalents.html#reshaping_data).
