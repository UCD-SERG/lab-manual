...
Running `R CMD check` workflows on GitHub Actions is computationally expensive and slow,
as runners spin up fresh virtual environments and install all dependencies from scratch each time.
