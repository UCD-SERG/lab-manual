...
For more information on roxygen2 syntax and features,
see <https://roxygen2.r-lib.org/>.
...
3. **Validate unexpected arguments**: Consider using the <a href="https://ellipsis.r-lib.org/">`{ellipsis}`</a> package to catch misspelled argument names:
