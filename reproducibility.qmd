...
Using reporting checklists helps ensure that peer-reviewed articles contain the information needed for readers to assess the validity of your work and/or attempt to reproduce it. A collection of reporting checklists is available from the [EQUATOR Network](https://www.equator-network.org/) [@equatornetwork].
