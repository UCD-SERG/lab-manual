...
Please see the reproducible example provided by the [Proctor Lab at UCSF](https://proctor-ucsf.github.io/dcc-handbook/publicdata.html) that you can run and replicate when making data public for your projects. The example contains the following files and folders:
...
For additional guidance on data documentation best practices, see the [UC Davis DataLab workshop on data documentation](https://github.com/ucdavisdatalab/workshop_how-to-data-documentation).  
