...
Please see the reproducible example provided by the Proctor Lab at UCSF that you can run and replicate when making data public for your projects. It contains the following files and folders:
