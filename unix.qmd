...
## User interfaces: CLI, TUI, and GUI {#sec-cli-tui-gui}

{{< include unix/_interfaces-cli-tui-gui.qmd >}}
...
![Example desktop with folders and files](assets/images/ex-desktop.jpg){#fig-unix-desktop}

## Terminal Emulators {#sec-terminal-emulators}

{{< include unix/terminal-emulators.qmd >}}
...
: Basic Unix commands for Mac and Windows {#tbl-unix-basic-commands}

![Terminal output after executing basic Unix commands](assets/images/ex-terminal.PNG){#fig-unix-terminal}

## Zsh and Oh My Zsh {#sec-zsh}

{{< include unix/_zsh-and-oh-my-zsh.qmd >}}
...
: Commands for running Bash scripts {#tbl-unix-bash-scripts}


## Shell Scripting Style {#sec-shell-style}

{{< include unix/shell-scripting-style.qmd >}}
...
For a comprehensive introduction to command-line tools,
shell workflows,
and practical computing environments,
see [The Missing CS Quarter at UC Davis](https://missing.cs.ucdavis.edu/)
