...
2. Fill out the [UC Davis GitHub Organization Access Request form](https://ucdavis.co1.qualtrics.com/jfe/form/SV_6zKEZU8KK74rUeV?Q_JFE=qdg)
3. When you receive the invitation email,
   ...
   ![UC Davis GitHub invitation with Copilot seat option](https://github.com/user-attachments/assets/e813f3ef-3eda-46a6-ba88-eb917ad082d2)
   :::

4. Click "Join UC Davis" to accept the invitation
5. Follow the setup instructions to install and configure Copilot in your development environment
...
3. Find the "ucdavis" entry and click the request button
   ...
   ::: {.content-visible when-format="html"}
   ![GitHub Copilot settings page showing organization options](https://github.com/user-attachments/assets/33179245-2ce8-439c-a301-2a1c30cae0e3)
   :::
