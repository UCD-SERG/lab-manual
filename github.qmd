...
2. Contact the UC Davis GitHub organization administrators to request a Copilot seat
   - You can find contact information and request instructions through your department or the UC Davis IT support
   - Alternatively, ask your lab PI or lab manager for guidance on the current process
3. Once your request is approved, you'll receive an invitation to enable Copilot on your account
4. Follow the setup instructions to install and configure Copilot in your development environment

For guidance on using GitHub Copilot effectively,
see @sec-ai-best-practices in the Working with AI chapter.

## Github Desktop
While knowing how to use Git on the command line will always be useful since the full power of Git and its customizations and flexibilty is designed for use with the command line, Github also provides GitHub Desktop [@githubdesktop] as an graphical interface to do basic git commands; you can do all of the basic functions of Git using this desktop app. Feel free to use this as an alternative to Git on the command line if you prefer.
