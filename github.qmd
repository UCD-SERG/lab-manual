...
- [GitHub Learn](https://learn.github.com/) hosts official interactive courses,
...
![ ](assets/images/github-copilot-invitation-email.png)
...
![](assets/images/github-copilot-settings-page.png)
...
since the full power of Git and its customizations and flexibility is
designed for use with the command line,
GitHub also provides GitHub Desktop [@githubdesktop]
as a graphical interface to do basic git commands;
you can do all of the basic functions of Git using this desktop app.
Feel free to use this as an alternative to Git on the command line if you prefer.
...
## Pull Request Roles and Protocol

The lab's pull request roles,
author and reviewer expectations,
stacked pull requests (@sec-stacked-pull-requests),
and review-response protocol
are consolidated in @sec-collab-dev.
This GitHub chapter focuses on Git mechanics
and GitHub-specific platform features.
...
## Removing Sensitive Data from a Repository {#sec-removing-sensitive-data}

{{< include github/_sec-removing-sensitive-data.qmd >}}
