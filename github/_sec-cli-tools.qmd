...
see the [wai site's "Installing Claude Code on Windows" section](https://d-morrison.github.io/wai/chapters/coding-agents.html#sec-ai-claude-code-windows) for the `winpty` workaround if the interactive
prompt fails.
