...
**Demo paragraph for testing change highlighting**: This paragraph is added to demonstrate the change highlighting feature in PR previews. When this PR is rendered, you should see highlighting on this new paragraph. If the highlighting is glitchy, you can add the `no-preview-highlights` label to disable it. The highlighting feature shows modified text in yellow, added text in green, and new sections in blue. 
