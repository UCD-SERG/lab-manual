...
in installed-package code it usually emits *no warning at all*,
so it slips past interactive use, CI, and code review unnoticed.
...
because the warning is suppressed before it is ever signaled.
