...
the [`include-code-files`](https://github.com/quarto-ext/include-code-files) extension provides a filter
to include code directly into fenced code blocks with syntax highlighting
and line or snippet selection.
