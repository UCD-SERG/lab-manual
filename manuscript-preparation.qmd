...
## Intro: Formatting tables with `gtsummary` + `flextable` + `flexlsx`
...
convert to [`{flextable}`](https://cran.r-project.org/package=flextable)
for styling,
...
- Define table content with `gtsummary::tbl_summary()` (or model tables).
