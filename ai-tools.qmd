...
Like the Agents in the Matrix films [@matrix_agents],
Skynet in Terminator [@skynet],
HAL 9000 in 2001: A Space Odyssey [@hal9000],
the Replicants in Blade Runner [@blade_runner],
Ender commanding his simulation in Ender's Game [@enders_game],
and the warnings about thinking machines in Dune's Butlerian Jihad [@butlerian_jihad],
...
but they require careful oversight and control to ensure they serve your interests and that you understand the consequences of their actions.
