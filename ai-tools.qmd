...
[@matrix; @terminator; @space_odyssey; @blade_runner; @enders_game; @i_robot; @wargames; @humans_are_dead; @butlerian_jihad]
...
![[Agents from The Matrix](https://en.wikipedia.org/wiki/The_Matrix)](assets/images/matrix-agents.png){fig-alt="Three agents in suits and sunglasses from the Matrix films"}
