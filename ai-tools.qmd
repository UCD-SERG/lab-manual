...
([AI agents](https://en.wikipedia.org/wiki/AI_agent) specialized for coding)
...
Science fiction has long explored the promises and perils of artificial intelligence.
Like the [Agents in the Matrix films](https://en.wikipedia.org/wiki/Agent_(The_Matrix)),
[Skynet in Terminator](https://en.wikipedia.org/wiki/Skynet_(Terminator)),
[HAL 9000 in 2001: A Space Odyssey](https://en.wikipedia.org/wiki/HAL_9000),
the [Replicants in Blade Runner](https://en.wikipedia.org/wiki/Blade_Runner),
and the warnings about thinking machines in [Dune's Butlerian Jihad](https://en.wikipedia.org/wiki/Butlerian_Jihad),
...
but they require careful oversight and control—like [Ender commanding his simulation in Ender's Game](https://en.wikipedia.org/wiki/Ender%27s_Game)—to ensure they serve your interests and that you understand the consequences of their actions.
