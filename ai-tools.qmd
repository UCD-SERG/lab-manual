...
![Agents from the Matrix films: powerful programs that require careful oversight](assets/images/matrix-agents.png){#fig-matrix-agents fig-alt="Three agents in suits and sunglasses from the Matrix films"}
