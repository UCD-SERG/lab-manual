...
Adapted by UCD-SeRG team from [original by Anna Nguyen, Jade Benjamin-Chung, and Gabby Barratt Heitmann](https://jadebc.github.io/lab-manual/slurm.html)
...
UC Davis provides SLURM-based computing clusters at shiva.ucdavis.edu. For detailed documentation, visit the [UC Davis HPC website](https://hpc.ucdavis.edu/). Below, we include general tips for working with Slurm-based computing clusters.
