# Code repositories {#sec-code-repositories}
...
{{< include code-repositories/package-structure.qmd >}}

## `.Rproj` files

{{< include code-repositories/rproj-files.qmd >}}

## Organizing the `data-raw` folder

{{< include code-repositories/project-structure.qmd >}}

## Repository Status Badges {#sec-repostatus}

{{< include code-repositories/repository-status.qmd >}}
