...
- **Account setup**: Request and confirm access to GitHub (join the `UCD-SERG` organization),
  Slack, UC Davis email, and lab Box and Google Drive folders.
...
- **Team introductions**: Introduce yourself on the lab Slack channel and at the next weekly lab meeting.
