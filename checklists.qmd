...
- **Required trainings**: Complete required CITI human subjects and HIPAA/IRB training modules
  (see @sec-protecting-human-subjects).
- **Read the lab manual**: Review lab culture and conduct (@sec-culture-and-conduct),
  coding style (@sec-coding-style), and collaborative development (@sec-collab-dev).
