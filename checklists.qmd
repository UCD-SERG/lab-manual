...
- Are legends and other labels easy to understand with minimal abbreviations? 
...
- **Data archiving**: Archive or transfer large datasets, raw files, and simulation outputs per lab storage protocols
  (see @sec-data-publication and @sec-slurm).
...
- **Account transition**: Coordinate with lab leadership to transition or revoke personal access
  to shared lab accounts, server credentials, and IRB protocols.
