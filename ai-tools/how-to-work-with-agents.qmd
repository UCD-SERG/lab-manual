...
- **Chat/app agents (for example Claude or Codex-style chat interfaces)**:
  ...
  but often need more manual copy/edit/execute steps unless tightly integrated with your repository tools.
- **IDE-integrated agents**:
  Best for mixed human+agent editing.
...
and finish with human review in a pull request.
