...
For example,
when you have errors in the spell-check workflow,
it's often faster to run `spelling::update_wordlist()` yourself than
to have Copilot do it for you.
Also, when reviewing Copilot's PRs, it's often faster to directly edit the
PR branch than to write clear review comments and ask Copilot to address them.
