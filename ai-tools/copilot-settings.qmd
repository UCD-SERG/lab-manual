...
`Codex` refers to OpenAI models tuned for software development tasks.
In GitHub Copilot model names,
the `-Codex` suffix indicates code-focused variants
intended for code generation and editing workflows.
