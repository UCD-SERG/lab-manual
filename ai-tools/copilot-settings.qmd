...
The OpenAI quickstart describes Codex as an agent-oriented coding workflow
available through an IDE extension
that can read files, run commands, and write changes,
and it links to a dedicated Codex app for local projects:
...
including desktop app availability on Windows and macOS:
...
{{< include ai-tools/copilot-settings/connecting-positron-to-openai.qmd >}}
