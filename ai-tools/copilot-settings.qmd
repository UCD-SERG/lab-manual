...
OpenAI describes Codex as a coding agent for software development
([source](https://developers.openai.com/codex)).
In the Copilot model list below,
entries with the `-Codex` suffix denote code-focused variants.
