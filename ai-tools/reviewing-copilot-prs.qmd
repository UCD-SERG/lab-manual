...
- **Issue creator**: Reports a bug, suggests a feature, or requests other improvements
- **PR prompter**: Assigns a developer (human or AI) to start working on a PR, often by assigning an issue to Copilot
